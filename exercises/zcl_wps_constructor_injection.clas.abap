class ZCL_WPS_CONSTRUCTOR_INJECTION definition
  public
  final
  create public .
...
CLASS ZCL_WPS_CONSTRUCTOR_INJECTION IMPLEMENTATION.


  METHOD get_amount_in_coins.
    DATA(cash_provider) = CAST ZIF_WPS_CASH_PROVIDER( NEW ZCL_WPS_CASH_PROVIDER( ) ).
